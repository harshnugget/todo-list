import Manager, { UITools } from './Manager';
import TaskManager from './TaskManager';
import { deleteIcon, renameIcon } from './images/svg';
...
export default class ProjectManager extends Manager {
  ...
  createElement(project) {
    ...
    const childElements = {
      input: UITools.newElement('input', {
        type: 'text',
